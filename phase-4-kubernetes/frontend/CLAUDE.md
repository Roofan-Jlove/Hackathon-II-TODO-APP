...
| Setting | Value |
|---------|-------|
| Type | `LoadBalancer` (for Minikube) |
| Port | 80 |
| Target Port | 3000 |
...
helm upgrade todo-frontend ./helm-charts/frontend
...
**Note:** Backend URL uses Kubernetes service name (`todo-backend`), not external URL. Kubernetes DNS resolves this automatically.

---

## RUNNING THE APP (Updated for Phase IV)
...
**Project:** Phase II-III-IV - Full-Stack Web Application with AI Chatbot & Kubernetes
**Frontend Stack:** Next.js 16+ (App Router) + TypeScript + Tailwind CSS + OpenAI ChatKit + Docker + Kubernetes
**Authentication:** Better Auth (JWT cookies)
**Containerization:** Docker (Multi-stage build) + Kubernetes (Minikube) + Helm
**Last Updated:** 2026-01-21
**Status:** Phase IV - Kubernetes Deployment
